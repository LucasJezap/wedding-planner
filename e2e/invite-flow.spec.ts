...
test("admin can invite and activate a new planner account", async ({
  ...
  await page.getByPlaceholder("Adres email").fill("lucasjezap@gmail.com");
  ...
  await page.getByPlaceholder("Hasło", { exact: true }).fill("Avatar3232!");
  await page.getByPlaceholder("Powtórz hasło").fill("Avatar3232!");
